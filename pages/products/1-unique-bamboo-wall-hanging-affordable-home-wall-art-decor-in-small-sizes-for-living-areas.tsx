...
export default function BambooWallHangingPage() {
  ...
  useEffect(() => {
    ...
    shopifyFetch({
      query: PRODUCT_QUERY,
      variables: { handle: "1-unique-bamboo-wall-hanging-affordable-home-wall-art-decor-in-small-sizes-for-living-areas" },
    })
      .then((data) => {
