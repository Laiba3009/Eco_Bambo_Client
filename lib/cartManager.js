...
class CartManager {
  ...
  async addToCart(variantId, quantity = 1) {
    ...
    try {
      ...
      // Note: Auto-sync disabled - using direct Shopify redirects instead
      cartLogger.debug('CartManager', 'Item added to headless cart - use direct Shopify URLs for sync');
